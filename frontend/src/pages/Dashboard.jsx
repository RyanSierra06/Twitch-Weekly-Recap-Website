...
export default function Dashboard() {
  ...
  console.log('📊 Dashboard render - fullyLoading:', fullyLoading);
  console.log('📊 Dashboard render - profilesLoaded:', profilesLoaded, 'vodsLoaded:', vodsLoaded, 'clipsLoaded:', clipsLoaded);
